...
// Add NewChatIcon for chat actions
...
// Add MinimizeIcon for chat window topbar (using a simple dash)
...
// Alias XIcon to CloseIcon
export const XIcon = CloseIcon;

// Adding BotIcon and BotOffIcon
